...
public class CumlativeStatFrameView extends StatFrameView implements ListSelectionListener
{
	JTable table;
	...
	public static CumlativeStatFrameView openWindow(java.util.List<Packet> packets,JDStatisticsTaker staker){
		CumlativeStatFrameView frame=new CumlativeStatFrameView(packets,staker);
		frame.setVisible(true);
		return frame;
	}
	
	CumlativeStatFrameView(java.util.List<Packet> packets,JDStatisticsTaker staker){
