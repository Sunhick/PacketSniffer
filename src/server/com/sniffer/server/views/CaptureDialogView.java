...
import com.sniffer.server.controllers.CaptureDialogController;

public class CaptureDialogView extends JDialog implements ActionListener
{
	/**
	 * 
	 */
	...
	public JComboBox<String> adapterComboBox;
	public JTextField filterField,caplenField;
	public JRadioButton wholeCheck,headCheck,userCheck;
	public JCheckBox promiscCheck;
	...
	public CaptureDialogView(JFrame parent){
		super(parent,"Choose Device and Options",true);
		listener = new CaptureDialogController(this);
		...
		if(devices==null){
			...
			adapterComboBox=new JComboBox<String>(names);
		}
	...
	public static JpcapCaptor getJpcap(JFrame parent){
		CaptureDialogView cdview = new CaptureDialogView(parent);
