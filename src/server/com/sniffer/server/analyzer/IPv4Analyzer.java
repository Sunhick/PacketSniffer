package com.sniffer.server.analyzer;
...
public class IPv4Analyzer extends PacketAnalyzer
{
	...
	public Object getValue(String valueName){
		if((valueNames[13].equals(valueName) && values.get(valueName) instanceof InetAddress) ||
		   (valueNames[14].equals(valueName) && values.get(valueName) instanceof InetAddress)){
			...
			if(PacketCaptor.hostnameCache.containsKey(addr))
				values.put(valueName,PacketCaptor.hostnameCache.get(addr));
			else{
